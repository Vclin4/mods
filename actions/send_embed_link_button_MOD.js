module.exports = {
	...
	fields: ['channelID', 'serverID', 'color', 'title', 'author', 'authorUrl', 'authorIcon', 'desc', 'imageUrl', 'thumbUrl', 'footer', 'footerIcon', 'buttonsCount', 'firstButtonLink', 'firstButtonText', 'secondButtonLink', 'secondButtonText', 'thirdButtonLink', 'thirdButtonText', 'fourthButtonLink', 'fourthButtonText', 'fifthButtonLink', 'fifthButtonText'],
...
<div id ="modinfo" style="width: 550px; height: 350px; overflow-y: scroll; overflow-x: scroll;">
  ...
  <input id="serverID" class="round"style="margin-top: 4px" type="text" placeholder="Server ID"><br>
	...
	async action(cache) {
		...
		switch (buttonsCount) {
			case '1':
				buttons = [{ "type": 2, "style": 5, "url": firstButtonLink, "label": firstButtonText }]
				break
			case '2':
				buttons = [
