module.exports = {
    ...
    subtitle(data) {
        return `Generate ${data.lang} "${data.countWord}" Random Word(s)`;
    },
    ...
    fields: ["storage", "varName", "lengthWord", "countWord", "lang", "dictionary", "optionalWord"],
...
<div>
  ...
  <div id="varNameContainer" style="float: right; width: 60%; padding-top: 8px">
    ...
    action(cache) {
        ...
        const dictionary = parseInt(data.dictionary);
        const lang = parseInt(data.lang);
        ...
        switch (lang) {
            case "EN":
                randomWords = ["ability", "able", "aboard", "about", "above", "accept", "accident", "according",
                                     "account", "accurate", "acres", "across", "act", "action", "active", "activity", "actual",
                                     ...
                                     "anybody", "anyone", "anything", "anyway", "anywhere", "apart", "apartment", "appearance",
                                     ...
                                     "baby", "back", "bad", "badly", "bag", "balance", "ball", "balloon", "band", "bank", "bar",
                                     ...
                                     "broken", "brother", "brought", "brown", "brush", "buffalo", "build", "building", "built",
                                     "buried", "burn", "burst", "bus", "bush", "business", "busy", "but", "butter", "buy", "by",
                                     ...
                                     "chapter", "character", "characteristic", "charge", "chart", "check", "cheese", "chemical",
                                     ...
                                     "correct", "correctly", "cost", "cotton", "could", "count", "country", "couple", "courage",
                                     ...
                                     "deep", "deeply", "deer", "definition", "degree", "depend", "depth", "describe", "desert",
                                     ...
                                     "electricity", "element", "elephant", "eleven", "else", "empty", "end", "enemy", "energy",
                                     ...
                                     "fat", "father", "favorite", "fear", "feathers", "feature", "fed", "feed", "feel", "feet",
                                     "fell", "fellow", "felt", "fence", "few", "fewer", "field", "fierce", "fifteen", "fifth",
                                     "fifty", "fight", "fighting", "figure", "fill", "film", "final", "finally", "find", "fine",
                                     "finest", "finger", "finish", "fire", "fireplace", "firm", "first", "fish", "five", "fix",
                                     "flag", "flame", "flat", "flew", "flies", "flight", "floating", "floor", "flow", "flower",
                                     ...
                                     "frequently", "fresh", "friend", "friendly", "frighten", "frog", "from", "front", "frozen",
                                     ...
                                     "gift", "girl", "give", "given", "giving", "glad", "glass", "globe", "go", "goes", "gold",
                                     ...
                                     "happy", "harbor", "hard", "harder", "hardly", "has", "hat", "have", "having", "hay", "he",
                                     "headed", "heading", "health", "heard", "hearing", "heart", "heat", "heavy", "height",
                                     "held", "hello", "help", "helpful", "her", "herd", "here", "herself", "hidden", "hide",
                                     "high", "higher", "highest", "highway", "hill", "him", "himself", "his", "history", "hit",
                                     ...
                                     "jack", "jar", "jet", "job", "join", "joined", "journey", "joy", "judge", "jump", "jungle",
                                     "just", "keep", "kept", "key", "kids", "kill", "kind", "kitchen", "knew", "knife", "know",
                                     "knowledge", "known", "label", "labor", "lack", "lady", "laid", "lake", "lamp", "land",
                                     "language", "large", "larger", "largest", "last", "late", "later", "laugh", "law", "lay",
                                     "layers", "lead", "leader", "leaf", "learn", "least", "leather", "leave", "leaving", "led",
                                     ...
                                     "lonely", "long", "longer", "look", "loose", "lose", "loss", "lost", "lot", "loud", "love",
                                     ...
                                     "melted", "member", "memory", "men", "mental", "merely", "met", "metal", "method", "mice",
                                     "middle", "might", "mighty", "mile", "military", "milk", "mill", "mind", "mine",
                                     "minerals", "minute", "mirror", "missing", "mission", "mistake", "mix", "mixture", "model",
                                     ...
                                     "onto", "open", "operation", "opinion", "opportunity", "opposite", "or", "orange", "orbit",
                                     ...
                                     "plastic", "plate", "plates", "play", "pleasant", "please", "pleasure", "plenty", "plural",
                                     "plus", "pocket", "poem", "poet", "poetry", "point", "pole", "police", "policeman",
                                     "political", "pond", "pony", "pool", "poor", "popular", "population", "porch", "port",
                                     "position", "positive", "possible", "possibly", "post", "pot", "potatoes", "pound", "pour",
                                     "powder", "power", "powerful", "practical", "practice", "prepare", "present", "president",
                                     "press", "pressure", "pretty", "prevent", "previous", "price", "pride", "primitive",
                                     "principal", "principle", "printed", "private", "prize", "probably", "problem", "process",
                                     ...
                                     "rays", "reach", "read", "reader", "ready", "real", "realize", "rear", "reason", "recall",
                                     ...
                                     "step", "stepped", "stick", "stiff", "still", "stock", "stomach", "stone", "stood", "stop",
                                     "stopped", "store", "storm", "story", "stove", "straight", "strange", "stranger", "straw",
                                     ...
                                     "taken", "tales", "talk", "tall", "tank", "tape", "task", "taste", "taught", "tax", "tea",
                                     "teach", "teacher", "team", "tears", "teeth", "telephone", "television", "tell",
                                     "temperature", "ten", "tent", "term", "terrible", "test", "than", "thank", "that", "thee",
                                     ...
                                     "thrown", "thumb", "thus", "thy", "tide", "tie", "tight", "tightly", "till", "time", "tin",
                                     "tiny", "tip", "tired", "title", "to", "tobacco", "today", "together", "told", "tomorrow",
                                     ...
                                     "whatever", "wheat", "wheel", "when", "whenever", "where", "wherever", "whether", "which",
                                     ...
                                     "young", "younger", "your", "yourself", "youth", "zero", "zebra", "zipper", "zoo", "zulu"];
                break
            case "RU":
                randomWords = ["аароновец", "абажур", "аббат", "аббревиатура", "абброморфема", "абвер", "абверовец",
                                     ...
                                     "абракадабра", "абрек", "абрикос", "абрикотин", "арбуз", "апельсин", "абрис", "аброгация",
                                     ...
                                     "барак", "баран", "бард", "барий", "басня", "вагина", "вагон", "вагонетка", "ваза", "ВАЗ",
                                     "вакансия", "вакуум", "вакцина", "вал", "валенки", "валериана", "валет", "валик", "валун",
                                     "валькирия", "вальс", "вальцовка", "вальяжность", "валюта", "ведьма", "вампир",
                                     "вампиризм", "век", "велосипед", "вена", "венец", "вера", "верблюд", "габардин", "габитус",
                                     "гавань", "гадалка", "гадкий", "гадюка", "газ", "гайка", "газета", "газовоз", "газон",
                                     "галдёж", "галерея", "галка", "галеты", "гаметы", "гараж", "гарнизон", "даль", "дьявол",
                                     "дама", "дамба", "дамка", "дань", "дар", "дартс", "даун", "дача", "два", "движок", "дверь",
                                     ...
                                     "желе", "железа", "железо", "жёлоб", "желток", "жёлудь", "жеребец", "женьшень", "женщина",
                                     "жеребий", "жертва", "жестянка", "жесть", "жёстко", "жетон", "живот", "животноводство",
                                     "животное", "жижа", "Жигули", "жизнь", "жилет", "жилище", "жнец", "жлоб", "житие", "забег",
                                     "забор", "завал", "завеса", "завод", "завялый", "заветный", "завидный", "завуч", "загс",
                                     "зад", "задание", "зажора", "зазор", "заря", "заказ", "закал", "закалка", "заяц", "закат",
                                     "заклёпка", "закрома", "зал", "закуп", "залп", "залог", "залив", "замах", "замес", "замок",
                                     "замш", "замысел", "зануда", "запад", "западный", "занос", "запах", "запас", "записка",
                                     "запинка", "ива", "игла", "игра", "игрок", "идеал", "игуана", "идиот", "идея", "идол",
                                     "иероглиф", "изба", "изгиб", "изгой", "изгородь", "изжога", "излом", "изложение", "измена",
                                     ...
                                     "йог", "йога", "йогурт", "кабан", "кабачок", "кабель", "кабина", "каблук", "кадет", "код",
                                     ...
                                     "качок", "каша", "лаборант", "лава", "лаваш", "лавина", "лавка", "лавры", "лаг", "лагерь",
                                     "лагуна", "ладонь", "лазарет", "лазер", "лак", "лакомство", "лампа", "ламинат", "лампасы",
                                     "лангуст", "лапа", "лапти", "лапша", "ларёк", "латы", "латунь", "латынь", "лгун", "лебеда",
                                     ...
                                     "манифест", "манту", "мануфактура", "манускрипт", "манометр", "маньяк", "маразм", "мораль",
                                     ...
                                     "нагрузка", "нагрузчик", "надежда", "надзор", "надзорный", "надпись", "название", "наказ",
                                     ...
                                     "обнова", "обновление", "ободок", "образ", "обработка", "обряд", "обрыв", "обух", "обуза",
                                     ...
                                     "разлом", "размен", "размер", "разминка", "разный", "разовый", "разнос", "разум", "разряд",
                                     "разруха", "разрядка", "рай", "рак", "район", "раковина", "рама", "рана", "ранг", "раскат",
                                     "раса", "расклад", "расплата", "распри", "рассадник", "рассада", "распятие", "рассвет",
                                     "рассол", "рассказ", "рассудок", "разум", "раствор", "расход", "сабля", "сабор", "саботаж",
                                     ...
                                     "сатира", "сборник", "свалка", "сброс", "табак", "табакерка", "табель", "табу", "таблетка",
                                     ...
                                     "текила", "текстиль", "тележка", "телёнок", "телеметрия", "телепорт", "телескоп", "телеса",
                                     ...
                                     "фазан", "фаза", "файл", "факт", "факел", "факс", "фактограф", "факт", "фактура", "фаллос",
                                     ...
                                     "цель", "цена", "центр", "ценник", "цепь", "церковник", "цеп", "цианид", "цикл", "циклон",
                                     ...
                                     "шаль", "шампур", "шампунь", "шар", "шамовка", "шаман", "шалава", "шанс", "шантаж", "шарф",
                                     "шарм", "шахтёр", "швея", "щавель", "щебёнка", "щегол", "щека", "щепка", "щетина", "щётка",
                                     ...
                                     "ягуар", "яйцо", "як", "якорь", "яма", "ямб", "январь", "ярлык", "яркость", "ярмо", "яхта",
                                     "ярус", "ящик",];
                break
        }
